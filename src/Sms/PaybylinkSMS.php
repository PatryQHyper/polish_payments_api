...
class PaybylinkSMS extends WebClient
{
    private int $user_id;
    ...
    {
        $response = $this->doRequest('https://paybylink.pl/api/v2/index.php', [
            'userid' => $this->user_id,
        ...
        {
            throw new SmsException('Paybylink returned error '.$response->error->message, $response->error->errorCode);
        }
