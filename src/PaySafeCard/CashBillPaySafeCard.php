...
class CashBillPaySafeCard extends WebClient
{
    ...
    ): bool
    {
        ...
        $params['paymentChannel'] = 'paysafecard';
        ...
        $params['personalData.email'] = $email;
        ...
        if ($response->getStatusCode() != 200) {
            throw new PaySafeCardException('cashbill error ' . $response->getBody());
        }
