...
class CashBillTransfer extends WebClient
{
    ...
    public function generate(float $price, string $title, string $additionalData = '', string $description = '', string $returnUrl = NULL, string $negativeReturnUrl = NULL, string $email = NULL, string $paymentChannel = NULL, string $firstName = NULL, string $surname = NULL, string $language = 'PL', string $currency = 'PLN', $referer = NULL): bool
    {
        $params['title'] = $title;
